...
<h1 class="text-monocase text-capitalize text-center text-light">All The Doctor's Schedule List Of Cardiac Electrophysiologist</h1>
...
<ul class="pager font-weight-bold text-monospace">
  ...
  <li class="next "><a href="cardiologist.php">Next Page</a></li>
</ul></div><?php
	   include 'footer.html';?>
