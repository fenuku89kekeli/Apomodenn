...
<h1 class="text-center font-weight-bold text-white ">All The Doctor's Of  Surgeon</h1>
<style>ul{
font-size:24px;
}
h1{
...
body {margin:0;
padding:0; class="active text-dark"
width:100%;
height:100vh;
background-image:url(../pic/istockphoto-1203451574-170667a.jpg);
...
<ul class="pager font-weight-bold text-monospace">
  ...
  <li class="next"><a href="dentist_delete.php">Next</a></li>
</ul></div>
